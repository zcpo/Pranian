                ...
                <section className="main__playlists">
                    ...
                    <ul className="music__list">
                        {featuredMeditations.map((item) => {
                            ...
                            return (
                                <li key={item.slug}>
                                    <Link href={`/library/meditation/${item.slug}`} className="music__list-item" style={{backgroundImage: `url(${imageUrl})`}}>
                ...
                <section className="main__playlists">
                    ...
                    <ul className="music__list">
                         {featuredVideoMeditations.map((item) => {
                            ...
                            return (
                                <li key={item.slug}>
                                    <Link href={`/library/video-meditation/${item.slug}`} className="music__list-item" style={{backgroundImage: `url(${imageUrl})`}}>
                                        <div className="music__list-item-hover">
                                            <h3 className="song__title">{item.title}</h3>
                                            <p className="song__creator">{item.author}</p>
                                            <button className="play-button">
                ...
                <section className="main__playlists">
                    ...
                    <ul className="music__list">
                        {featuredVideos.map((item, index) => {
                            ...
                            return (
                                <li key={item.slug}>
                                    <Link href={`/library/video/${item.slug}`} className="music__list-item" style={{backgroundImage: `url(${imageUrl})`}}>
                                        <div className="music__list-item-hover">
                                            <h3 className="song__title">{item.title}</h3>
                                            <p className="song__creator">{item.author}</p>
                                            <button className="play-button">
