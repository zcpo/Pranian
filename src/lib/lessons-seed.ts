...
export const lessons: Lesson[] = [
    ...
    quiz: [
        {
            ...
            options: [
                {id: 'a', text: "On the student's standing foot."},
                {id: 'b', text: 'Lightly at the hips to help them feel the centerline.'},
                {id: 'c', text: 'On their arms to hold them up.'}
            ],
            correctAnswerId: 'b'
        },
    ]
  ...
  },
  {
    ...
    quiz: [
        {
            question: "'Dynamic stretching' is good for a warm-up because it:",
            options: [
                {id: 'a', text: "Involves holding a passive stretch for a long time."},
                {id: 'b', text: 'Moves the body through a range of motion, preparing it for more intense movement.'},
                {id: 'c', text: 'Involves bouncing in a stretch.'},
            ],
            correctAnswerId: 'b'
        },
    ]
