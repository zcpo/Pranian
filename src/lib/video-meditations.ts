export const videoMeditations = [
  ...
  { 
    slug: 'ocean-escape-visualization',
    title: 'Ocean Escape Visualization',
    description: 'Transport yourself to a peaceful beach with this guided imagery.',
    longDescription: 'Let your mind drift away to the soothing sounds of the ocean. This visualization meditation will guide you to a serene beach, helping you to wash away stress and find a deep sense of peace.',
    videoUrl: 'https://storage.googleapis.com/studioprod-5112a-assets/assets/pranian/video-meditation-1.m3u8',
    posterUrl: 'https://images.unsplash.com/photo-1507525428034-b723a9ce6890?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxiZWFjaCUyMHN1bnNldHxlbnwwfHx8fDE3MjE4NzU3Njd8MA&ixlib=rb-4.1.0&q=80&w=1080',
    imageId: 'video-meditation-1',
    author: 'Pranian Wellness',
    duration: '12:00',
    bullets: [
        ...
        'Mentally escape to a tranquil place.',
        'Listen to the calming sounds of waves.',
    ],
  },
    { 
    slug: 'forest-walk-meditation',
    title: 'Forest Walk Meditation',
    description: 'Ground yourself with the sights and sounds of a lush forest.',
    longDescription: 'Take a virtual walk through a beautiful, green forest. This guided meditation uses vivid imagery and nature sounds to help you feel grounded, refreshed, and connected to the natural world.',
    videoUrl: 'https://storage.googleapis.com/studioprod-5112a-assets/assets/pranian/video-meditation-2.m3u8',
    posterUrl: 'https://images.unsplash.com/photo-1448375240586-882707db888b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxmb3Jlc3R8ZW58MHx8fHwxNzIxODc1ODg4fDA&ixlib=rb-4.1.0&q=80&w=1080',
    imageId: 'video-meditation-2',
    author: 'Pranian Wellness',
    duration: '15:00',
    bullets: [
        ...
        'Calm your mind with serene visuals.',
        'Refresh your spirit.',
    ],
  },
];
